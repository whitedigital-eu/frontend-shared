<template>
  <span>
    ...
    >
      <g fill="none" fill-rule="evenodd">
        <g transform="translate(1 1)">
          <circle cx="5" cy="50" :fill="color" r="5">
            <animate
              attributeName="cy"
              begin="0s"
              calcMode="linear"
          ...
          <circle cx="27" cy="5" :fill="color" r="5">
            <animate
              attributeName="cy"
              begin="0s"
              calcMode="linear"
          ...
          <circle cx="49" cy="50" :fill="color" r="5">
            <animate
              attributeName="cy"
              begin="0s"
              calcMode="linear"
    ...
    >
      <g fill="none" fill-rule="evenodd">
        <g :stroke="color" stroke-width="1.5" transform="translate(2 1)">
          <circle cx="42.601" cy="11.462" :fill="color" fill-opacity="1" r="5">
            <animate
              attributeName="fill-opacity"
              begin="0s"
              calcMode="linear"
          ...
          <circle cx="49.063" cy="27.063" :fill="color" fill-opacity="0" r="5">
            <animate
              attributeName="fill-opacity"
              begin="0s"
              calcMode="linear"
          ...
          <circle cx="42.601" cy="42.663" :fill="color" fill-opacity="0" r="5">
            <animate
              attributeName="fill-opacity"
              begin="0s"
              calcMode="linear"
          ...
          <circle cx="27" cy="49.125" :fill="color" fill-opacity="0" r="5">
            <animate
              attributeName="fill-opacity"
              begin="0s"
              calcMode="linear"
          ...
          <circle cx="11.399" cy="42.663" :fill="color" fill-opacity="0" r="5">
            <animate
              attributeName="fill-opacity"
              begin="0s"
              calcMode="linear"
          ...
          <circle cx="4.938" cy="27.063" :fill="color" fill-opacity="0" r="5">
            <animate
              attributeName="fill-opacity"
              begin="0s"
              calcMode="linear"
          ...
          <circle cx="11.399" cy="11.462" :fill="color" fill-opacity="0" r="5">
            <animate
              attributeName="fill-opacity"
              begin="0s"
              calcMode="linear"
          ...
          <circle cx="27" cy="5" :fill="color" fill-opacity="0" r="5">
            <animate
              attributeName="fill-opacity"
              begin="0s"
              calcMode="linear"
    ...
    >
      <defs>
        <linearGradient id="a" x1="8.042%" x2="65.682%" y1="0%" y2="23.865%">
          ...
          <stop offset="63.146%" :stop-color="color" stop-opacity=".631" />
        </linearGradient>
      </defs>
      <g fill="none" fill-rule="evenodd">
        <g transform="translate(1 1)">
